...
namespace RISQTutorialDetectorParameters
{
  ...
  constexpr double dp_siliconChipDimZ = 1.0 * CLHEP::mm;
  

  //----------------------------
  //Detector dimensions
  constexpr double dp_capacitorDimX = 0.13 * CLHEP::mm;
  constexpr double dp_capacitorDimY = 0.13 * CLHEP::mm;
  constexpr double dp_capacitorDimZ = 0.01 * CLHEP::mm;

  constexpr double dp_inductorDimX = 0.25 * CLHEP::mm;
  constexpr double dp_inductorDimY = 0.25 * CLHEP::mm;
  constexpr double dp_inductorDimZ = 0.01 * CLHEP::mm;

  constexpr double dp_CPWDimX = 10.0 * CLHEP::mm;
  constexpr double dp_CPWDimY = 0.06 * CLHEP::mm;
  constexpr double dp_CPWDimZ = 0.01 * CLHEP::mm;
